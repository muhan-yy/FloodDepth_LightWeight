...
if __name__ == '__main__':
    ...
    image_ori_path = os.path.join('datasets', 'mulReference-seg', 'images', 'val', '64969919_2199033074.jpg')
    image_result_path = os.path.join('64969919_2199033074.jpg')
    model(image_ori_path, image_result_path)
...
layer	想要输出第几层的热力图就写几，我这里写的的-8, -5, -2，即表示输出倒数第8，5，2层的结果，可以多换换层数，大小，看看效果
